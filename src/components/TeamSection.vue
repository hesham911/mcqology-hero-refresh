<template>
  <section id="team" class="py-12 md:py-20 bg-gradient-to-b from-medical-teal/5 to-background">
    <div class="container mx-auto px-4 md:px-6">
      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-8">
        <div 
          ...
          :key="member.id"
          class="group relative bg-card rounded-2xl overflow-hidden shadow-soft hover:shadow-glow transition-all duration-300 hover:-translate-y-2"
        >
          <!-- Background Gradient -->
          <div class="absolute inset-0 bg-gradient-to-br from-medical-teal/5 to-medical-green/5 opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
          
          <!-- Content -->
          <div class="relative p-6 text-center">
            <!-- Avatar -->
            <div class="relative mb-6">
              <div class="w-24 h-24 mx-auto rounded-full overflow-hidden ring-4 ring-medical-green/20 group-hover:ring-medical-green/40 transition-all duration-300">
                <img 
                  :src="member.avatar" 
                  :alt="member.name"
              ...
              <!-- Status Indicator -->
              <div class="absolute -bottom-1 -right-1 w-6 h-6 bg-medical-green rounded-full border-4 border-card flex items-center justify-center">
            ...
            <!-- Info -->
            <div class="space-y-3">
              <h3 class="text-xl font-bold text-medical-teal">
                {{ member.name }}
              </h3>
              
              <div class="space-y-2">
                <p class="text-medical-green font-semibold">
                  {{ member.title }}
                </p>
              ...
              <!-- Social Links -->
              <div class="flex justify-center space-x-4 pt-4 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                <button class="w-8 h-8 bg-medical-teal/10 hover:bg-medical-teal hover:text-white rounded-full flex items-center justify-center transition-colors duration-200">
      ...
      <div class="text-center mt-16">
        <div class="bg-gradient-to-r from-medical-teal to-medical-green rounded-2xl p-8 text-white">
...
import { Linkedin, Mail, Globe } from 'lucide-vue-next'
